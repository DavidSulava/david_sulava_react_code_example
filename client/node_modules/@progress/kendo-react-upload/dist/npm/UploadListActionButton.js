...
var UploadListActionButton = /** @class */ (function (_super) {
    ...
    function UploadListActionButton(props) {
        ...
        _this.buttonClassNames = function (type) {
            ...
            return kendo_react_common_1.classNames('k-button k-button-icon k-flat k-upload-action', _this.props.disabled ? 'k-disabled' : '', (actionFocused && type === 'action') || (retryFocused && type === 'retry') ? 'k-focus' : '');
        };
