...
var UploadActionButtons = /** @class */ (function (_super) {
    ...
    UploadActionButtons.prototype.render = function () {
        ...
        var clearButtonClasses = kendo_react_common_1.classNames('k-button k-button-md k-rounded-md k-button-solid k-button-solid-base', 'k-clear-selected', disabled ? 'k-disabled' : '', navigationIndex === clearButtonIndex ? 'k-focus' : '');
        var uploadButtonClasses = kendo_react_common_1.classNames('k-button k-button-md k-rounded-md k-button-solid k-button-solid-primary', 'k-primary', 'k-upload-selected', disabled ? 'k-disabled' : '', navigationIndex === uploadButtonIndex ? 'k-focus' : '');
